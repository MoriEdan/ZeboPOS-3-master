...
using Zebo.Infrastructure.Data.SQL;
using Zebo.Infrastructure.Data.Text;
using Zebo.Infrastructure.Settings;

namespace Zebo.Persistance.Data
{
        ...
        private static void Migrate(CommonDbContext context)
        {
            ...
            IRunnerContext migrationContext =
                new RunnerContext(announcer)
                {
                    ...
                    Database = db,
                    Target = LocalSettings.AppPath + "\\Zebo.Persistance.DbMigration.dll"
                };
