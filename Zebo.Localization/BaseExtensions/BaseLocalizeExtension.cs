...
namespace Zebo.Localization.BaseExtensions
{
    /// <summary>
    ...
    public abstract class BaseLocalizeExtension<TValue> : MarkupExtension, IWeakEventListener, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Holds the name of the assembly containing the WPF window or usercontrol which 
        /// is using this instance.
        /// </summary>
        private string dialogAssembly;
        ...
        {
            get { return this.assembly ?? this.dialogAssembly; }
        ...
        private static Assembly GetDialogAssembly(DependencyObject targetObject)
        {
            ...
            while (targetObject != null)
            {
                ...
                if (targetObject is UserControl || targetObject is Window || targetObject is Page)
                {
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            // Use the assembly defining the dialog if no assembly was provided
