...
using Zebo.Infrastructure.Data.BinarySerializer;
using Zebo.Infrastructure.Settings;

namespace Zebo.Infrastructure.Data.Text
{
    public class TextFileWorkspace : IWorkspace, IReadOnlyWorkspace
    {
        ...
        {
            return Path.GetDirectoryName(Assembly.GetCallingAssembly().Location) + "\\ZeboDB.txt";
        }
