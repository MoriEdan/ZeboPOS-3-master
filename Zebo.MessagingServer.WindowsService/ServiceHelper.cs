...
namespace Zebo.MessagingServer.WindowsService
{
    public static class ServiceHelper
    {
        private static readonly string _installAssembly = "Zebo.MessagingServer.WindowsService.exe";
        private static readonly string _logFile = "WindowsServiceInstall.log";
        private static readonly string _serviceName = "ZeboPOS3-MessagingServer";
