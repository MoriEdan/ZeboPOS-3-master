...
namespace Zebo.Presentation.Tests
{
    [TestFixture]
    public class InventoryTests
    {
        ...
        public void TestCost()
        {
            ...
            ticket.AddOrder(AccountTransactionType.Default, testContext.Department, "Tangun", testContext.Iskender, null, testContext.Iskender.Portions[0], "", null);
            ticket.AddOrder(AccountTransactionType.Default, testContext.Department, "Tangun", testContext.Iskender, null, testContext.Iskender.Portions[0], "", null);
            ticket.AddOrder(AccountTransactionType.Default, testContext.Department, "Tangun", testContext.Iskender, null, testContext.Iskender.Portions[0], "", null);
        ...
        public void CanFilterUnneededConsumptionItems()
        {
            ...
            workspace.Add(ticket);
            var order = ticket.AddOrder(AccountTransactionType.Default, testContext.Department, "Tangun", testContext.Iskender, null, testContext.Iskender.Portions[0], "", null);
            order.Quantity = 600;
            ...
            workspace.Add(ticket);
            order = ticket.AddOrder(AccountTransactionType.Default, testContext.Department, "Tangun", testContext.Iskender, null, testContext.Iskender.Portions[0], "", null);
            order.Quantity = 600;
        ...
        private static IWorkspace PrepareMenu(string fileName)
        {
            ...
            pth = Path.Combine(pth, "..\\..\\..\\Zebo.Presentation");
