...
namespace Zebo.Presentation.Tests
{
    ...
    public static class MefBootstrapper
    {
        ...
        static MefBootstrapper()
        {
            ...
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Zebo.Persistance.dll"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Zebo.Presentation*"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Zebo.Services*"));
