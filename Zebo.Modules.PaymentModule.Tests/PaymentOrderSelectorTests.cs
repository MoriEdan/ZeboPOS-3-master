...
namespace Zebo.Modules.PaymentModule.Tests
{
    ...
    public class PaymentOrderSelectorTests
    {
        ...
        private static Ticket SetupTicket()
        {
            ...
            var order = ticket.AddOrder(AccountTransactionType.Default, Department.Default, "Tangun", tost, null, new MenuItemPortion { Price = 5, Name = "Adet" }, "", null);

            order.Quantity = 2;
            order.PortionCount = 2;
            ticket.AddOrder(AccountTransactionType.Default, Department.Default, "Tangun", tost, null, new MenuItemPortion { Price = 5, Name = "Adet" }, "", null);
            ticket.AddOrder(AccountTransactionType.Default, Department.Default, "Tangun", hamburger, null, new MenuItemPortion { Price = 7, Name = "Adet" }, "", null);
            ticket.AddOrder(AccountTransactionType.Default, Department.Default, "Tangun", hamburger, null, new MenuItemPortion { Price = 6, Name = "Adet" }, "", null);
            ticket.Recalculate();
            return ticket;
        }
        ...
        public void CanHandleTax()
        {
            ...
            var order = ticket.AddOrder(AccountTransactionType.Default, Department.Default, "Tangun", tost, taxTemplates, new MenuItemPortion { Price = 5, Name = "Adet" }, "", null);

            order.Quantity = 2;
            order.PortionCount = 2;
            ticket.AddOrder(AccountTransactionType.Default, Department.Default, "Tangun", tost, taxTemplates, new MenuItemPortion { Price = 5, Name = "Adet" }, "", null);
            ticket.AddOrder(AccountTransactionType.Default, Department.Default, "Tangun", hamburger, taxTemplates, new MenuItemPortion { Price = 7, Name = "Adet" }, "", null);
            ticket.AddOrder(AccountTransactionType.Default, Department.Default, "Tangun", hamburger, taxTemplates, new MenuItemPortion { Price = 6, Name = "Adet" }, "", null);
