...
namespace Zebo.Services.Tests
{
    ...
    class EntityTests
    {
        ...
        public void CanSetDefaultValues()
        {
            ...
            Assert.AreEqual("Çapulcu Tangun", customer4.Name);
        ...
        {
            var customer1 = new Entity { Name = "Tangun Caner", EntityTypeId = CustomerEntityType.Id };
            ...
            Assert.AreEqual("Tangun Caner", phoneSearch2[0].Name);
        }
