...
using Zebo.Presentation.Common.ErrorReport;
...
namespace Zebo.Modules.BasicReports
{
    public abstract class ReportViewModelBase : ObservableObject
    {
        ...
        public void AddDefaultReportHeader(SimpleReport report, WorkPeriod workPeriod, string caption)
        {
            ...
            report.AddHeader(!string.IsNullOrEmpty(userInfo) ? userInfo : "ZeboPOS");
        ...
        public void AddDefaultReportFooter(FlowDocument report)
        {
            ...
            p.Inlines.Add(new Run("Powered by ZeboPOS V3") { FontWeight = FontWeights.Bold });
            report.Blocks.Add(p);
        }
    }
}
